...
<body>
    ...
    <div>
        ...
        <h2 style="text-align:center">
            <asp:Label ID="lbl_software" runat="server" Text=""></asp:Label>
        </h2>
    </div>
            ...
            <table style="border-style: solid; border-color:black; width:70%; margin-right: 15%; margin-left: 17%;">
                <tr>
                    <td style="border-right-style:solid;border-color:black" class="auto-style1">
                        ...
                        <br />
                        <asp:Label ID="lbl_language2" runat="server" Text="" Visible="False" meta:resourceKey="lbl_language2"></asp:Label>
                        <br />
                        ...
                        <br />
                        <asp:DropDownList ID="ddl_language2" runat="server" AutoPostBack="true" Visible="False">
                            <asp:ListItem Value="en-US">English</asp:ListItem> 
                             <asp:ListItem Value="es">español</asp:ListItem> 
                             <asp:ListItem Value="zh">中文 </asp:ListItem> 
                            <asp:ListItem Value="ar">العربية</asp:ListItem> 
                    ...
                    <td class="auto-style2">
                        ...
                        <asp:Label ID="lbl_ms" runat="server" Text="Ms." Visible="False" meta:resourceKey="lbl_ms"></asp:Label>
                        ...
                        <asp:Label ID="lbl_graddate" runat="server" Text="Label" Visible="False"></asp:Label>
                        <br />
                        <br />
                        ...
                        &nbsp;<asp:Label ID="lbl_salary2" runat="server" Text="Label" Visible="False"></asp:Label>
                        ...
                        <asp:HyperLink ID="link_github" runat="server">Github</asp:HyperLink>
                        <br />
